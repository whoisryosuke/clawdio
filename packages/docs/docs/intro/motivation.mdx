...
Rust as a programming language has proven itself to be just as powerful as the titans of low level langugages, like C++. It's easy to get started with projects and dependencies thanks to it's [Cargo CLI](https://doc.rust-lang.org/cargo/). And it's memory management is next level, with a fantastic [first party linter](https://github.com/rust-lang/rustfmt) to assist with navigating it's ownership model.
